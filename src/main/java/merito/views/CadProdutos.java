...
public class CadProdutos extends javax.swing.JFrame {
    ...
    private void salvar(){
        if(tfCombustivel.getText().trim().isEmpty() || tfValor.getText().trim().isEmpty()){
            ...
            try {
                ...
                prod.setNome(tfCombustivel.getText());
                prod.setValor(Double.parseDouble(tfValor.getText()));
                
                if(tfId.getText().trim().isEmpty()){
                    prod.setId(UtilsDao.gerarId("com_id","tb_combustivel"));
                    produtoDao.cadastrarProduto(prod);
                    limparCampos();
                } else {
                    prod.setId(Long.parseLong(tfId.getText()));
    ...
    private void excluir() throws ClassNotFoundException{
        if(tbConsulta.getSelectedRow() != -1){
            ...
            produtoDao.excluirProduto(produtos.get(ls).getId());
            listar();
        }
    }
    ...
    private void mostrar(List<ProdutoModel> lista){
        inicializando = true;
